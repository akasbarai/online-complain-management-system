...
import { UploadCloud, MapPin, AlertCircle, Navigation } from 'lucide-react';
...
export const LodgeComplaint = () => {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold text-slate-900">Lodge a New Complaint</h2>
      <p className="text-slate-500 -mt-4">Submit a detailed report about a civic issue in your area.</p>
        ...
        <div className="lg:col-span-2">
          <Card className="p-6">
             <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                   <h3 className="text-sm font-semibold text-slate-900 uppercase tracking-wide mb-4 border-b pb-2">1. Basic Details</h3>
                ...
                <div>
                   <h3 className="text-sm font-semibold text-slate-900 uppercase tracking-wide mb-4 border-b pb-2">2. Location & Description</h3>
                   <div className="space-y-4">
                     <div>
                ...
                <div>
                   <h3 className="text-sm font-semibold text-slate-900 uppercase tracking-wide mb-4 border-b pb-2">3. Evidence (Optional)</h3>
                      ...
                      <label htmlFor="evidence-upload" className="cursor-pointer flex flex-col items-center justify-center gap-2">
                         {formData.imageUrl ? (
                           ...
                           <div className="py-6 text-center">
                              ...
                              <p className="text-sm text-slate-600 font-medium">Click to upload photos or documents</p>
        ...
        <div className="space-y-6">
           <Card className="p-5 bg-blue-50 border-blue-100">
              ...
              <ul className="text-sm text-blue-800 space-y-2 list-disc pl-4">
                 <li>Provide a clear and specific subject title.</li>
                 <li>Give precise location details or landmarks.</li>
                 <li>Upload photos to help officers identify the issue faster.</li>
                 <li>Select the most relevant department.</li>
              </ul>
           </Card>
        </div>
      </div>
