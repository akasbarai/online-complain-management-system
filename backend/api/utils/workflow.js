...
const STATUS_TRANSITIONS = {
  Submitted: ['Under Review', 'Assigned', 'Rejected', 'Withdrawn'],
  'Under Review': ['Assigned', 'Rejected', 'Withdrawn'],
  Assigned: ['In Progress', 'Awaiting Materials', 'Escalated', 'Rejected', 'Withdrawn'],
  'In Progress': ['Awaiting Materials', 'Resolved', 'Escalated', 'Rejected', 'Withdrawn'],
  'Awaiting Materials': ['In Progress', 'Resolved', 'Escalated', 'Rejected', 'Withdrawn'],
  Escalated: ['Assigned', 'In Progress', 'Resolved', 'Rejected', 'Withdrawn'],
  Resolved: ['Closed'],
  Rejected: ['Closed'],
  Closed: [],
  Withdrawn: []
...
const getEscalationTargetLevel = async (pool, departmentId, hierarchyLevelId) => {
  if (!departmentId || !hierarchyLevelId) return hierarchyLevelId || null;
  ...
  return rules.length > 0 ? rules[0].target_level_id : hierarchyLevelId;
};
