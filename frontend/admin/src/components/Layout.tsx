...
import { 
  ...
  FileText, BarChart3, Bell, UserCheck, LogOut, MessageSquareWarning, ListChecks
} from 'lucide-react';
    ...
    <div className="flex h-screen bg-slate-50 overflow-hidden">
      ...
      <aside className="w-64 bg-slate-900 text-slate-100 flex flex-col fixed h-full z-10">
        ...
        <nav className="flex-1 overflow-y-auto py-6 px-3 space-y-1">
          ...
          <SidebarItem to="/workflow" icon={ListChecks} label="Workflow Queue" count={(attention.complaints || 0) + (attention.users || 0) + (attention.officers || 0)} />
